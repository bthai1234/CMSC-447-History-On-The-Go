...
function initMap() {
    ...
    if (!document.getElementById("map")) {
        throw new Error('HTML element with id = map not found');
    }
...
function getSearchBox() {
    ...
    if (!document.getElementById("searchSubmitButton")) {
        throw new Error('HTML Button element with HTML id = searchSubmitButton not found');
    }
    ...
    $(document).ready(function () {
        ...
        for (const place of places) {
            if (place.geometry && place.geometry.location) {
                ...
                var submitButton = $(document.createElement('input')).attr({
                    "id": place.name + "_id",
                    "class": "btn btn-primary",
                    "type": "submit",
                    "value": "Save to Itinerary"
                });


                cardHeader.text(place.name);
                cardText.text("Lorem ipsum");
